...
import edu.kit.kastel.sdq.eclipse.common.api.client.websocket.ArtemisWebsocketException;
import edu.kit.kastel.sdq.eclipse.common.api.client.websocket.IWebsocketClient;
import edu.kit.kastel.sdq.eclipse.common.api.client.websocket.WebsocketCallback;
import edu.kit.kastel.sdq.eclipse.common.api.controller.IStudentArtemisController;
import edu.kit.kastel.sdq.eclipse.common.api.controller.IWebsocketController;
import edu.kit.kastel.sdq.eclipse.common.api.messages.Messages;
import edu.kit.kastel.sdq.eclipse.common.api.util.Pair;
import edu.kit.kastel.sdq.eclipse.common.client.mappings.exam.ArtemisStudentExam;
import edu.kit.kastel.sdq.eclipse.common.client.websocket.ArtemisFeedbackWebsocket;

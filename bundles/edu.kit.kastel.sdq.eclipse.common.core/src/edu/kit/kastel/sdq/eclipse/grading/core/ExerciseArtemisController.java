...
public class ExerciseArtemisController extends AbstractController implements IExerciseArtemisController {
    ...
    private void downloadExercise(IExercise exercise, File dir, String repoUrl, IProjectFileNamingStrategy namingStrategy)
            throws ArtemisClientException {
    ...
    private String createCommitMsg(ICourse course, IExercise exercise) {
        return String.format("[ECLIPSE-STUDENT] - uploaded new solution for exercise %s of course %s.", exercise.getShortName(),
                course.getShortName());
    }
}

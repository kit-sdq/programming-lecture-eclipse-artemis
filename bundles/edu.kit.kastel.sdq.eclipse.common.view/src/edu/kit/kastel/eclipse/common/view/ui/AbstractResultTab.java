...
public abstract class AbstractResultTab extends AbstractResultTabCompositeController {
     ...
     *
     * @return the current feedback as {@code [String completionTime, List<Feedback> feedbacks]}
     */
    protected abstract Pair<String, List<Feedback>> getCurrentResultAndFeedback();

    /**
     * Get the project name of the currently selected project in eclipse to add annotations based on
     * the feedback in Artemis. If set to {@code null} no annotations will be created.
     *
    ...
    /**
     * Returns the current source directory relative to the project directory. For students this
     * should be "src/".
     */
     ...
     *            the current project name in eclipse
     * @param sourceDirectory
     *            typically "src/" or "assignment/src/"
     * @param feedbacks
     *            all feedbacks (manual and automatic)
     */
    protected final void createAnnotationsMarkers(String currentProjectName, String sourceDirectory,
    ...
    private List<Annotation> convertToAnnotation(List<Feedback> feedbackForLines) {
        ...
        for (Feedback f : feedbackForLines) {
            ...
            Annotation annotation = new Annotation(id, type, startLine, endLine, fullyClassifiedClassName,

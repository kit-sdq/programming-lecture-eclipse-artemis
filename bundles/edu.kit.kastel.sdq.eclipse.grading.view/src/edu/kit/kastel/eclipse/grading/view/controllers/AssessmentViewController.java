...
/**
 * This class is the controller for the grading view. It creates the marker for the annotations and holds all controller
...
public class AssessmentViewController {
    ...
    public void addAssessmentAnnotation(IMistakeType mistake, String customMessage, Double customPenalty, String ratingGroupName) {
        ...
        try {
            ...
            /*
             * Future Work: the error handling should be more specific (maybe for each setAttribute(...)) without
             * getting a too messy code
             */
            e.printStackTrace();

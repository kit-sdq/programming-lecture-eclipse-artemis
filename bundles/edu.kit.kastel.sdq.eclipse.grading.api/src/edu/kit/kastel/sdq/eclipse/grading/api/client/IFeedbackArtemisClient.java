...
public interface IFeedbackArtemisClient {
	...
	/**
	 * Returns all feedbacks for a given result and participation. A participation is bound to a specific exercise. 
	 * If the result does not exist or forbidden or if the user does not have permissions to access the participation it throws ArtmisClientException.
	 * 
	 * @param participation
	 * @param result

...
public interface IArtemisClient {
    ...
    default List<ISubmission> getSubmissions(IExercise exercise) throws ArtemisClientException {
        ...
        // TODO This is just a fix that you can see second correction rounds iff available
     ...
     *
     * @param exerciseID
     * @param assessedByTutor only return those submissions on which the caller has (started, saved or submitted) the
     *                        assessment.
     ...
     *
     * @param participation THOU SHALT NOT PROVIDE THE SUBMISSIONID, HERE! The participationID can be gotten from the
     *                      {@link ILockResult}, via {@link #startAssessment(int)} or
     *                      {@link #startNextAssessment(int, int)}! * @param submit determine whether the assessment
     *                      should be submitted or just saved.
     ...
     * @throws ArtemisClientException if some errors occur while parsing the result or if authentication fails.
     */

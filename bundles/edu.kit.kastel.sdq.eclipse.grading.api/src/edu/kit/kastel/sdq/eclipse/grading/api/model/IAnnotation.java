...
/**
 * An annotation is one specific occurrence of a IMistakeType. There might be multiple Annotations.
 *
 * Note that penalty calculation is done collectively: {@link IMistakeType#calculatePenalty(java.util.List)} You may
 * define a custom penalty which might be used by some MistakeType (more precise: by its PenaltyRule). Also, you may
...
public interface IAnnotation {
    ...
    /**
     *
     * @return the relative path to the class, formatted like "src/edu/kit/informatik/BubbleSort" (as that is what
     *         artemis requires)
     */

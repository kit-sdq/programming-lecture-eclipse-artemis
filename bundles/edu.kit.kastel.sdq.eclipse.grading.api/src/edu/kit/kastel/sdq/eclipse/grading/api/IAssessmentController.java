...
/**
 * The assessmentController handles everything that has to do with the assessment of a single
 * submission.
 */
public interface IAssessmentController {
     ...
     *            fully classified class name of the respective Class to be annotated
     * @param customMessage
     *            custom message set by tutor
     * @param customPenalty
     *            This may or may not have an effect, depending on the MistakeType's PenaltyRule!
     * @param marker_char_start
     *            additional encoding of the start (counts from file start, eclipse GUI requires
     *            this)
     * @param marker_char_end
     *            additional encoding of the start (counts from file start, eclipse GUI requires
     ...
     */
    void addAnnotation(int annotationID, IMistakeType mistakeType, int startLine, int endLine,
     ...
     *            new custom message
     * @param customPenalty
     *            new custom penalty. This may or may not have an effekt, depending on the
     *            MistakeType's PenaltyRule! E.g. a ThresholdPenaltyRule will not consider custom
     *            penalties while a (thinkable) "AggregatedPenaltyThresholdPenaltyRule" would do so.
     */

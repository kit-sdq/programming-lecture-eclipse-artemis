...
public interface IWebsocketClient {
	/**
	 * Connect to websocket and subscribe to result and submission topic.
	 * For SSL token is used to authenticate.
	 * The callback defines handling for incoming events or errors.
	 * 

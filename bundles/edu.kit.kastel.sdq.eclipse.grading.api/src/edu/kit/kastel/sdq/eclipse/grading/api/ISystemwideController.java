...
public interface ISystemwideController {
    ...
    /**
     * <B>BACKLOG</B><br/>
     * Get all submissions (their project names) which were sometime started by the calling tutor.
     * Based on current exercise. ISystemwideController::setExerciseId() must have been called
     * before! TODO see tolle Zustandsautomat-Grafik!
     *
     * @param filter
     *            determine which kinds of submissions should be filtered (= be in the result)
    ...
    /**
     *
     * Get assessment controller for current state (courseID, exerciseID, submissionID,
     * exerciseConfig).
     */
    ...
    /**
     * <B>BACKLOG</B><br/>
     * <li>Loads an already assessed (started, saved or even submitted) submission for
     * re-assessment.
     *
     * <li>You need to select a submission via {@link #setAssessedSubmission(int)}, first! Has the
     * same effect as {@link #startAssessment()} otherwise.
     ...
     */
    Collection<String> setCourseIdAndGetExerciseShortNames(String courseShortName) throws ArtemisClientException;
     ...
     * <li>See docs/Zustandshaltung-Automat
     *
     * @return whether a new assessment was started or not, depending on whether there was a
    ...
    /**
     * <B>ASSESSMENT</B><br/>
     * <li>Saves and submits the assessment to Artemis. Deletes project (in eclipse and on files
     * system) thereafter.
     * <li>See docs/Zustandshaltung-Automat
     */
